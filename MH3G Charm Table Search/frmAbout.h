...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->lblName->Location = System::Drawing::Point(12, 204);
			this->lblName->Name = L"lblName";
			this->lblName->Size = System::Drawing::Size(252, 13);
			this->lblName->TabIndex = 1;
			this->lblName->Text = L"Athena\'s Charm Table Search for MH3G and MH3U";
			// 
			// lblVersion
			// 
